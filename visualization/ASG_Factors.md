...
#### Note: 
These will include generally more advanced or unexpected statistics because we know the importance of the basic counting stats, like points, rebounds, and assists.  Also, my model attempt to stick to per game statistics as I do not have pre-all-star game statistics. Using full season totals would decrease it's reliability when I obtain first half of the season statistics for the upcoming year. 
...
- The scatterplot below displays how Offensive Win Shares (OWS) and Defensive Win Shares (DWS) relate to all-star selections for NBA players of the past two seasons. Win shares credits players with a share of their teams success, accumulating throughout the season. As this statistics is additive, I do not need to filter based on games played.
